...
internal class StudentEntityTypeConfiguration : IEntityTypeConfiguration<Student>
{
    public void Configure(EntityTypeBuilder<Student> builder)
    {
        ...
        builder.Property<InstitutionId>("_institutionId").HasColumnName("institutionId").HasConversion(c => c.Id, c => new InstitutionId(c));
        builder.Property<string>("_email").HasColumnName("email");
        builder.Property<string>("_password").HasColumnName("password");
        builder.Property<string>("_name").HasColumnName("name");
        builder.Property<RegistrationNumber>("_registrationNumber").HasColumnName("registrationNumber")
            .HasConversion(
                v => v.ToString(),
        ...
        builder.Property<byte>("_discountType").HasColumnName("discountType");
    }
}